...
export interface paths {
  ...
  "/items/OpenSource": {
    /**
     * List Items
     * @description List the OpenSource items.
     */
    get: operations["readItemsOpenSource"];
    /**
     * Create an Item
     * @description Create a new OpenSource item.
     */
    post: operations["createItemsOpenSource"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing OpenSource items.
     */
    delete: operations["deleteItemsOpenSource"];
    /**
     * Update Multiple Items
     * @description Update multiple OpenSource items at the same time.
     */
    patch: operations["updateItemsOpenSource"];
  };
  "/items/OpenSource/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single OpenSource item by unique identifier.
     */
    get: operations["readSingleItemsOpenSource"];
    /**
     * Delete an Item
     * @description Delete an existing OpenSource item.
     */
    delete: operations["deleteSingleItemsOpenSource"];
    /**
     * Update an Item
     * @description Update an existing OpenSource item.
     */
    patch: operations["updateSingleItemsOpenSource"];
  };
  "/items/static": {
    /**
     * List Items
     * @description List the static items.
     */
    get: operations["readItemsStatic"];
    /**
     * Create an Item
     * @description Create a new static item.
     */
    post: operations["createItemsStatic"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing static items.
     */
    delete: operations["deleteItemsStatic"];
    /**
     * Update Multiple Items
     * @description Update multiple static items at the same time.
     */
    patch: operations["updateItemsStatic"];
  };
  "/items/static/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single static item by unique identifier.
     */
    get: operations["readSingleItemsStatic"];
    /**
     * Delete an Item
     * @description Delete an existing static item.
     */
    delete: operations["deleteSingleItemsStatic"];
    /**
     * Update an Item
     * @description Update an existing static item.
     */
    patch: operations["updateSingleItemsStatic"];
  };
}
...
export interface operations {
  ...
  readItemsOpenSource: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsOpenSource"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsOpenSource: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsOpenSource"][] | components["schemas"]["ItemsOpenSource"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsOpenSource: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsOpenSource"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsStatic: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsStatic"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsStatic: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsStatic"][] | components["schemas"]["ItemsStatic"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsStatic: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsStatic"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type Schema = {
  OpenSource: components["schemas"]["ItemsOpenSource"][];
  static: components["schemas"]["ItemsStatic"][];
};
